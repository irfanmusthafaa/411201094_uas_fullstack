                    ...
                    <div class="card-body">
                        <form method="POST" action="{{url('lokasi/'.$detail->id)}}">
                            ...
                            <div class="form-group">
                                ...
                                @enderror
                                <input type="text" class="form-control" id="kode_lokasi" name="kode_lokasi" value={{$detail->kode_lokasi}}>

                                <label for="nama_lokasi" class="required">Nama Lokasi</label>
                                @error('nama_lokasi')
                                <div class="error">{{ $message }}</div>
                                @enderror
                                <input type="text" class="form-control" id="nama_lokasi" name="nama_lokasi"  required value={{$detail->nama_lokasi}}>
                            </div>
